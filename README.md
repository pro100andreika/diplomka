...
7).	Разработано пользовательское приложение на Flask, выдаваемое прогноз "Модуль упругости при растяжении, Гпа").
...
ML_Flask - папка с файлами для корректной работы пользовательского приложения, включая само приложение

Выпускная работа_Никитин_Андрей.ipynb - ноутбук с работой

Презентация ВКР Никитин Андрей.pptx - презентация ВКР для защиты

Пояснительная записка Никитин Андрей.docx - описание работы



Инструкция использования приложения:

Приложение позволяет решать задачу прогнозирования "Модуль упругости при растяжении, Гпа". 
Для получения прогноза необходимо (перед использованием не забудьте подгрузить зависимости)

а)     •	запустить app.py, 

б)     •	в появившейся строке ( * Running on http://127.0.0.1:5000/ (Press CTRL+C to quit)) - нажать на ссылку: http://127.0.0.1:5000/. 

в)     •	В новом открывшемся окне (сайте) ввести 12 входных параметров и нажать "Отправить".

г)     •	в специальном разделе появится результат в виде числа с плавающей точкой. 


Автор: Никитин Андрей Евгеньевич 
